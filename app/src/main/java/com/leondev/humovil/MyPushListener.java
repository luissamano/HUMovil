...
public class MyPushListener implements PushListener {
    ...
    public void onPushNotificationReceived(Activity activity, PushNotification pushNotification) {
        ...
        if (message != null) {
            ...
            Toast.makeText(activity, String.format(activity.getString(R.string.google_app_id), customData), Toast.LENGTH_LONG).show(); // For example R.string.push_toast would be "Push clicked with data=%1s"
        }
    }
}